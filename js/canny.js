...
// ;(function(exports){
  ...
  Canny.prototype._traverseEdge = function(current, imgData, threshold, traversed) {//traverses the current pixel until a length has been reached
    ...
    var neighbors = Helpers.getEdgeNeighbors(current, imgData, threshold, traversed);//pass the traversed group to the getEdgeNeighbors so that it will not include those anymore
